...
known_face_encodings = [mahesh_encoding, yash_encoding]
known_face_names = ["Mahesh", "Yash"]
...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        if name in known_face_names:
            ...
            bottomLeftConerOfText = (10, 100)
            fontScale = 1.5
            fontColor = (255, 0, 0)
            thickness = 3
            lineType = 2
            cv2.putText(frame, name + " Present", bottomLeftConerOfText, font, fontScale, fontColor, thickness, lineType)
